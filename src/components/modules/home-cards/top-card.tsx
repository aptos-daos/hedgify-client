...
const TopCard = () => {
  const items = [
    { label: "Market Capital", value: "$12,55,666" },
    { label: "Volume", value: "$55,666" },
    { label: "Liquidity", value: "$22,55,666" },
  ];

  const commonClasses = "overflow-hidden border-foreground p-4 pt-7 bg-white/10 z-10 rounded-xl border gap-4 transition relative";
  const desktopClasses = "hidden md:flex md:flex-row md:flex-wrap md:gap-5 md:min-h-80 md:h-[15rem] md:w-[50rem]";
